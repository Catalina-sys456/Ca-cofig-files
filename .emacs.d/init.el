...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cargo company counsel dap-mode highlight-symbol lsp-ui pyvenv
	   rainbow-delimiters rust-mode treemacs-projectile undo-tree
	   use-package-chords use-package-hydra yasnippet-snippets)))
(custom-set-faces
